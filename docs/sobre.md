...
## Mais exemplos e tipos de conteudo
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla et euismod nulla. Curabitur feugiat, tortor non consequat finibus, justo purus auctor massa, nec semper lorem quam in massa.

> mais sobre isso você encontra [aqui](https://squidfunk.github.io/mkdocs-material/reference/admonitions/#octicons)

!!! note danger "Phasellus posuere in sem ut cursus"
...
<!-- pular uma linha, ou apertar ENTER -->
<br>
...
**Importante**: as advertências que usam os modificadores devem ser declaradas antes do bloco de conteúdo que você deseja colocá-las ao lado. Se não houver espaço suficiente para renderizar a admoestação ao lado do bloco, a advertência se estenderá até a largura total do visor, por exemplo, em viewports móveis. `inline`
